...
/***/ (function(module, exports, __webpack_require__) {
	...
	var str = __webpack_require__(73);
...
/***/ (function(module, exports) {
	...
	module.exports = "<div class=\"re-header\">  <img src=\"/build/images/re-logo.png\" alt=\"\" /></div><div class=\"re-main\" ng-controller=\"codeLoginCtrl\" ng-app=\"codeLogin\">  <div class=\"re-ipt\">    <div>      <span>输入手机号</span>      <input class=\"re_mobile\" type=\"text\" />    </div>    <div>      <span>输入验证码</span>      <input class=\"re_smscode\" type=\"text\" />      <a class=\"re-code\" href=\"javascript:void(0);\">        <img src=\"/build/images/re-codebg.png\"/>        <span ng-click=\"get_smscode()\">获取验证码</span>      </a>    </div>  </div>  <div class=\"re-loginmode\">    <a class=\"re-login-mode\" href=\"re-login-account.html\">账号密码登录</a>  </div>  <div class=\"re-login-footer\">    <a class=\"re-submit-btn\" href=\"##\">      <span ng-click=\"code_loginBtn()\">登录</span>    </a>    <p>未注册的手机号将自动创建为你找我租账号</p>  </div></div>"
